  ...
  <div class="doc-div">
    ...
    <div class="doc-indent">
      ...
      <k-table
          ...
          :data="[
            {attr: 'type', type: 'String', des: '设置类型，可选值：primary，info，danger，success，warning，text', def: 'default'},
            {attr: 'size', type: 'String', des: '设置尺寸，可选值：mini，small，normal，large', def: 'normal'},
